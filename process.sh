...
awk -F, '/hilton/ {tolower($2); if($12 > 0){country1[tolower($7)]+= $12; count1[tolower($7)]+= 1}} /holiday inn/ {tolower($2); if($12>0){country2[tolower($7)]+= $12; count2[tolower($7)]+= 1}} END { for(i in country1) { print "CLEANLINESS", i, country2[i]/count2[i], country1[i]/count1[i]}}'  /home/datamove/hotels.csv
